...
@Component({
    selector: "app-header-boarding",
    templateUrl: "./boarding.header.component.html",
    styleUrls: ["./boarding.header.component.scss"]
})
export class BoardingHeaderComponent implements OnInit {
    started = false;
    visible = true;
    gauth = false;
    fauth = false;
